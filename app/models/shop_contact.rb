class ShopContact < ApplicationRecord
  ...
  validates :shop_name, presence: {message: I18n.t(:form_shop_name_error, scope: [:message, :contact_form])}
  validates :person_name, presence: {message: I18n.t(:form_person_name_error, scope: [:message, :contact_form])}
